...
//-----------------------------------------------------------------------------
int CModelBomberman::m_nTotalAl = 0;


//-----------------------------------------------------------------------------
// constructor
//-----------------------------------------------------------------------------
CModelBomberman::CModelBomberman() {
...
// draw the model
//-----------------------------------------------------------------------------
void CModelBomberman::Draw(bool bnDrawSpheres)
{
  //aux vars
  vector<CSphere *>::iterator itpoSpheres;
...
// check collision
//-----------------------------------------------------------------------------
float CModelBomberman::CheckCollisionRay(float *pfPosition, float *pfDirection)
{
  //aux vars
  vector<CSphere *>::iterator itpoSpheres;
...
// rotate the model
//-----------------------------------------------------------------------------
void CModelBomberman::RotateY(float fAngle) {
...
// translate the model
//-----------------------------------------------------------------------------
void CModelBomberman::Translate(float fX, float fY, float fZ) {
